...
class GameTag(IntEnum):
	...
	CANT_DRAW_DURING_MULLIGAN = 1673
	...
	BG_COMBAT_SPEED_MIN_COMBAT_EVENTS_REMAINING_TO_START = (
		BG_COMBAT_SPEED_MIN_ATTACKS_REMAINING_TO_START
	)
...
class CardSet(IntEnum):
	...
	RETURN_OF_THE_LICH_KING = 1776  # March of the Lich King
	BATTLE_OF_THE_BANDS = 1809  # Festival of Legends
	CORE_HIDDEN = 1810
	TITANS = 1858
	PATH_OF_ARTHAS = 1869
	WILD_WEST = 1892
	...
	EVENT = 1941
	EMERALD_DREAM = 1946  # Into the Emerald Dream
	THE_LOST_CITY = 1952  # The Shrouded City
	TIME_TRAVEL = 1957  # Across the Timeways
	PET = 1961  # Pet
	CATACLYSM = 1980  # Cataclysm
	ESCAPEFROM_VIOLET_HOLD = 1988
	BE = 1994  # Reign of the Black Empire
	...
	# Renamed
	PLACEHOLDER_202204 = CORE_HIDDEN
	FP2 = BRM
	PE2 = TEMP1 = TGT
	REWARD = HOF
...
class GameType(IntEnum):
	...
	def as_bnet(self, format: FormatType = FormatType.FT_STANDARD):
		...
		return {
			...
			GameType.GT_UNDERGROUND_ARENA: BnetGameType.BGT_UNDERGROUND_ARENA
		}[self]
...
class Booster(IntEnum):
	...
	YEAR_OF_PHOENIX = YEAR_OF_THE_PHOENIX
